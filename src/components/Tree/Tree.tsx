...
export const Tree: React.FC<ITreeProps> = (props) => {
    const { multipleChoice = true, nodes = [], updateNodes, updateExpandNode } = props;
    ...
    const zTreeOnCheck = (_event?: any, _treeId?: string, treeNode?: ITreeNode) => {
    ...
    const zTreeOnClick = (_event?: any, _treeId?: string, treeNode?: ITreeNode, _clickFlag?: number) => {
    ...
    const zTreeOnExpand = (_event?: any, _treeId?: string, treeNode?: ITreeNode) => {
        if (treeNode && treeNode.open !== undefined) {
            updateExpandNode(treeNode.id, treeNode.open);
        }
    };
    const zTreeOnCollapse = (_event?: any, _treeId?: string, treeNode?: ITreeNode) => {
        if (treeNode && treeNode.open !== undefined) {
            updateExpandNode(treeNode.id, treeNode.open);
        }
    };
