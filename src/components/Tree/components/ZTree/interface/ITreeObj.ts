...
export interface ITreeObj {
    setting?: string;
    addNodes?: (parentNode: any, index: any, newNodes: any, isSilent: any) => void;
    ...
    expandNode?: (node: any, expandFlag: any, sonSign: any, focus: any, callbackFlag: any) => void;
    ...
    getNodes?: () => {};
    getNodesByFilter?: (filter: any, isSingle: any, parentNode: any, invokeParam: any) => void;
    ...
    reAsyncChildNodes?: (parentNode: any, reloadType: any, isSilent: any, callback: any) => void;
    reAsyncChildNodesPromise?: (parentNode: any, reloadType: any, isSilent: any) => void;
    refresh?: () => {};
